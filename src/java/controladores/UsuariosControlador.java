    ...
    public static Usuarios buscarId(Usuarios usuario) {
        if (Conexion.conectar()) {
            String sql = "select * from usuarios u ,roles r where "
                    + "u.id_rol=r.id_rol and u.id_usuario='" + usuario.getId_usuario() + "'";
        ...
        if (Conexion.conectar()) {
            try {
                ...
                try (PreparedStatement ps = Conexion.getConn().prepareStatement(sql)) {
                    ...
                    while (rs.next()) {
                        tabla += "<tr>"
                                + "<td class='centrado'>" + rs.getString("id_usuario") + "</td>"
                                + "<td class='centrado'>" + rs.getString("nombre_usuario") + "</td>"
                                + "<td class='centrado'>" + rs.getString("login_usuario") + "</td>"
                                + "</tr>";
                    }
                    if (tabla.equals("")) {
