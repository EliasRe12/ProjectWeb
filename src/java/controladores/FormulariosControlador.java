        ...
        if (Conexion.conectar()) {
            try {
                ...
                try (PreparedStatement ps = Conexion.getConn().prepareStatement(sql)) {
                    ...
                    while (rs.next()) {
                        tabla += "<tr>"
                               + "<td class='centrado'>" + rs.getString("id_formulario") + "</td>"
                               + "<td class='centrado'>" + rs.getString("nombre_formulario") + "</td>"
                               + "<td class='centrado'><input type='text' value='" + rs.getString("codigo_formulario") + "' size=50 readonly='readonly'></td>"
                               + "<td class='centrado'>" + rs.getString("nombre_menu") + "</td>"
                               + "</tr>";
                    }
                    if(tabla.equals("")){
