function validarFormulario() {
    var valor = true;
    if ($("#telefono_personal").val().length < 2) {
        valor = false;
        $("#mensajes").html("'Campo Teléfono' No puede estar vacío.");
        $("#id_personal").focus();
    }
    if ($("#ci_personal").val().length < 2) {
        valor = false;
        $("#mensajes").html("'Campo C.I.' No puede estar vacío.");
        $("#id_personal").focus();
    }
    if ($("#apellido_personal").val().length < 2) {
        valor = false;
        $("#mensajes").html("'Campo Apellido' No puede estar vacío.");
        $("#id_personal").focus();
    }
